(function(){
  ...
  function disableWhatsapp(){
    document.querySelectorAll('a[href*="wa.me/"]').forEach(a=>{
      if(a.dataset.waDisabled==='true')return;
      a.dataset.waDisabled='true';
      a.removeAttribute('href');
      a.setAttribute('aria-disabled','true');
      a.setAttribute('title','WhatsApp @mcastilloperona próximamente disponible');
      a.style.cursor='default';
      a.addEventListener('click',e=>e.preventDefault());
    });
    document.querySelectorAll('.wa-note').forEach(n=>n.textContent='@mcastilloperona · próximamente');
    document.querySelectorAll('.wa').forEach(w=>{
      w.setAttribute('aria-label','WhatsApp @mcastilloperona próximamente disponible');
      w.setAttribute('title','WhatsApp @mcastilloperona próximamente disponible');
    });
  }
  ...
  document.addEventListener('DOMContentLoaded',()=>{
    ...
    enhanceFooter();
    disableWhatsapp();
    const waObserver=new MutationObserver(disableWhatsapp);
    waObserver.observe(document.body,{childList:true,subtree:true});
    window.setTimeout(()=>waObserver.disconnect(),5000);
  });
})();
